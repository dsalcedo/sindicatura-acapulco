        ...
        <div class="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
            ...
            <div class="hidden lg:flex">
                ...
                <div class="w-1/3 text-center py-8">
                    <div class="border-r">
                        <div class="text-grey-darker mb-2">
                            <span class="text-3xl align-top"><span class="text-green align-top">+</span>MXN$</span>
                            <span class="text-5xl">12,998</span>
                            <span class="text-3xl align-top">.48</span>
                        </div>
                        <div class="text-sm uppercase text-grey tracking-wide">
                            Desde el mes pasado (MXN)
                        </div>
                    </div>
                </div>
                <div class="w-1/3 text-center py-8">
                ...
                <div class="flex-grow flex flex-col bg-white border-t border-b sm:rounded sm:border shadow overflow-hidden">
                    <div class="border-b">
                        <div class="flex justify-between px-6 -mb-px">
                            <h3 class="text-blue-dark py-4 font-normal text-lg">Portafolio</h3>
                            <div class="flex">
                    ...
                    <div>
                        <div class="text-center px-6 py-4">
                            <div class="py-8">
                                ...
                                <p class="text-2xl text-grey-darker font-medium mb-4">No hay pagos recibidos</p>
